...
{
   g_expTitle="RISK STRIP — ریسک برگشت";
   ExpAddWrapped("چیست: این نوار یک خط خواندنی است، نه سیگنال — نشان می‌دهد قیمت همین حالا چقدر به یک برگشت نزدیک است و اگر برگشت بیاید، اولین سطح مقابل کدام است", clrWhite);
...
void RenderRiskStrip()
{
   ...
   // Phase 42: Latin readout labels first, pure Persian after each separator.
   string txt=StringFormat("BIAS: %s  |  ریسک برگشت: %s (%d)  |  سطح: %s [%s]  |  فاصله %.2f برابر میانگین دامنه  |  لگ %.0f درصد",
